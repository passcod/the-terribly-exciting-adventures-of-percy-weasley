...
particular reason[^2] an entry in a thesaurus[^3]) was clear enough, for once.
...
was [exhausting?], being babied by books was just awful. He had a "discarded"
pile next to his "read" and "to-read" piles[^10] where all such offensively
babyish books now resided, as well as boring treaties (cauldron thickness
wasn't that interesting) and books with too many words that the dictionary
didn't have an entry for.
...
potential[[TK: check if 7th weasley was born yet, and maybe add something about
it]], it only contained a variant of something called the Animagus potion,
...
around with this particular kind and practice of magic. "Ours", he crowned in
imitation of Gollum's manner, before collapsing in giggles and hopping off his
bed in search of some kind of snack.
...
[^3]: They have a habit of doing that, thesauruses.[^4]
